...
// Exposed so lib/time.js can build a full week's schedule without
// duplicating day-ordering/abbreviation logic.
export const WEEK_DAY_ORDER = daysOrder;
export const DAY_ABBR = dayCodeToAbbrMapping;
